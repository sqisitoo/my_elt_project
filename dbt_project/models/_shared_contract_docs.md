...
This documentation is the column-level surface of the same warehouse contract implemented in the `round_coordinate` macro: the normalized value is used for joins between OpenWeather observations and configured locations, and for surrogate-key generation.
